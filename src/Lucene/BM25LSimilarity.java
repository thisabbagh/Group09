...
public class BM25LSimilarity extends Similarity {
  ...
  private final float d; //adding delta for supporting BM25L
   ...
   */
  public BM25LSimilarity(float k1, float b) { // this will work as normal BM25
	    this.k1 = k1;
	    this.b  = b;
	    this.d =0;
	  }
  ...
  private Explanation explainScore(int doc, Explanation freq, BM25Stats stats, NumericDocValues norms) {
    ...
    tfNormExpl.addDetail(new Explanation(d, "parameter d")); /////////////////// for BM25L ////////////////////
    if (norms == null) {
      tfNormExpl.addDetail(new Explanation(0, "parameter b (norms omitted for field)"));
     // tfNormExpl.setValue((freq.getValue() * (k1 + 1)) / (freq.getValue() + k1)); //original impl. for BM25
      tfNormExpl.setValue(((freq.getValue()+d) * (k1 + 1)) / (freq.getValue() + k1 + d));/////////////////// for BM25L ////////////////////
    } else {
      float doclen = decodeNormValue((byte)norms.get(doc));
      tfNormExpl.addDetail(new Explanation(b, "parameter b"));
      tfNormExpl.addDetail(new Explanation(stats.avgdl, "avgFieldLength"));
      tfNormExpl.addDetail(new Explanation(doclen, "fieldLength"));
      //tfNormExpl.setValue((freq.getValue() * (k1 + 1)) / (freq.getValue() + k1 * (1 - b + b * doclen/stats.avgdl))); //original impl. for BM25
      tfNormExpl.setValue(((freq.getValue() + d) * (k1 + 1)) / ((freq.getValue() + d) + k1 * (1 - b + b * doclen/stats.avgdl)));/////////////////// for BM25L ////////////////////
    }
  ...
  public String toString() {
    return "BM25L(k1=" + k1 + ",b=" + b + ",d=" + d + ")";/////////////////// for BM25L ////////////////////
  }
